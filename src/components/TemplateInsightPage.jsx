...
import "./CSS/TemplateInsightPage.css";
import TemplateAnalysisChart from "./TemplateAnalysisChart";
      ...
      <div className="insight-header">
        ...
        <div className="date-selector">
          ...
          <div className="date-inputs">
            <input className="input" type="date" placeholder="Start Date" onChange={handleStartDateChange} />
            <input className="input" type="date" placeholder="End Date"  min={startDate}
         value={endDate}
